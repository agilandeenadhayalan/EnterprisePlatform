"""
Conflict Resolver service configuration — loaded from environment variables.
"""
...
class Settings(BaseSettings):
    """Conflict Resolver service configuration."""

    service_name: str = "Conflict Resolver Service"
