"""
Data Replication service configuration — loaded from environment variables.
"""
...
class Settings(BaseSettings):
    """Data Replication service configuration."""

    service_name: str = "Data Replication Service"
