"""
Stream Dedup Service — configuration loaded from environment variables.
"""
...
class Settings(BaseSettings):
    """Stream dedup service configuration."""

    service_name: str = "stream-dedup-service"
    service_port: int = 8116
    debug: bool = False
