"""
Stream Enrichment Service — configuration loaded from environment variables.
"""
...
class Settings(BaseSettings):
    """Stream enrichment service configuration."""

    service_name: str = "stream-enrichment-service"
    service_port: int = 8117
    debug: bool = False
