"""
Data models for kafka-consumer-locations.

ArchiveRequest: batch of location events to archive.
...
class ArchiveRequest(BaseModel):
    """Batch of location events to archive to MinIO Bronze layer."""

    events: list[dict] = Field(..., description="List of raw location event dicts")
    topic: str = Field("location.events.v1", description="Source Kafka topic")
