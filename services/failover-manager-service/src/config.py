"""
Failover Manager service configuration — loaded from environment variables.
"""
...
class Settings(BaseSettings):
    """Failover Manager service configuration."""

    service_name: str = "Failover Manager Service"
