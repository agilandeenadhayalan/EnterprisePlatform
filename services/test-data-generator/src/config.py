"""
Test Data Generator service configuration — loaded from environment variables.
"""
...
class Settings(BaseSettings):
    """Test Data Generator service configuration."""

    service_name: str = "Test Data Generator"
