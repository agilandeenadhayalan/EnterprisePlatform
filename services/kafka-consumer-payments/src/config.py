"""
Kafka Consumer Payments — configuration loaded from environment variables.
"""
...
class Settings(BaseSettings):
    """Kafka consumer payments configuration."""

    service_name: str = "kafka-consumer-payments"
    ...
    archive_prefix: str = "kafka/payment.events.v1"
